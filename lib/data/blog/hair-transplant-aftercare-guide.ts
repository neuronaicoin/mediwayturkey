...
export const post: BlogPost = {
  ...
  locale: "en",
  title: "Hair Transplant Aftercare: What to Do (and Avoid) for Best Results 2026",
  metaTitle: "Hair Transplant Aftercare Guide 2026: Recovery, Washing & What to Avoid | MediWayTurkey",
  metaDescription:
    "Complete hair transplant aftercare guide for 2026: day-by-day recovery, how to wash, what to avoid, sleeping position, when to exercise, and how to protect your grafts for the best results.",
  excerpt:
  ...
  sections: [
    {
      heading: "The first 24-48 hours: the most critical window",
      paragraphs: [
        ...
        "<strong>Do not touch, scratch, or rub</strong> the recipient area. Avoid wearing hats, helmets, or anything that presses on your scalp. Some swelling on the forehead is normal in the first few days and usually settles on its own.",
    ...
    {
      heading: "How to wash your hair after a hair transplant",
      paragraphs: [
    ...
    {
      heading: "What to avoid in the first two weeks",
      paragraphs: [
        "<strong>Avoid sweating and strenuous exercise.</strong> No gym, running, or heavy lifting for at least two weeks, as sweat and increased blood pressure can affect healing.",
        "<strong>Avoid alcohol and smoking.</strong> Both impair blood flow and slow healing. Ideally avoid them for at least the first week or two — longer is better.",
        "<strong>Avoid direct sun on the scalp.</strong> Keep your head out of strong sunlight for the first couple of weeks. If you must go out, use loose shade rather than a tight hat early on.",
        "<strong>Avoid swimming pools, saunas, and the sea</strong> for several weeks, as chlorine, heat, and bacteria can harm healing grafts.",
      ],
    },
    {
      heading: "The 'shock loss' phase: don't panic",
      paragraphs: [
    ...
    {
      heading: "Recovery timeline: what to expect month by month",
      paragraphs: [
        "<strong>Weeks 1-2:</strong> crusts heal and fall away, redness fades, swelling resolves. Most people return to office work within a few days.",
        "<strong>Weeks 3-8:</strong> shock loss occurs; the scalp looks much as it did before surgery. This is the quiet phase.",
        "<strong>Months 3-6:</strong> new hairs start to emerge, thin and fine at first. Density gradually builds.",
        "<strong>Months 9-12:</strong> the hair thickens and matures. The full, final result is usually visible at around twelve months — sometimes a little longer for the crown.",
      ],
    },
    {
      heading: "Habits that protect your long-term results",
      paragraphs: [
    ...
    {
      heading: "Why following your clinic's instructions matters most",
      paragraphs: [
        ...
        'A serious clinic provides clear aftercare guidance, a washing demonstration, and a way to contact them with questions during recovery. If you are still choosing where to have your procedure, you can <a href="/en/hair-transplant/istanbul">compare hair transplant clinics in Istanbul</a> and ask each one about their aftercare support before you decide.',
      ],
    },
    {
      heading: "Planning your treatment and trip",
      paragraphs: [
        'Good aftercare starts with choosing the right clinic. On MediWayTurkey you can <a href="/en/hair-transplant/istanbul">compare verified hair transplant providers</a> and contact them directly on WhatsApp, free of charge and with no commission. If you are combining treatments, you can also explore <a href="/en/dental/istanbul">dental clinics in Istanbul</a> or <a href="/en/aesthetics/istanbul">aesthetic clinics in Istanbul</a>.',
      ],
    },
  ],
  faqs: [
    ...
    {
      question: "Is it normal for transplanted hair to fall out?",
      answer:
