...
// "active: true" olan diller arayüzde görünür ama içeriği
...
export const LANGUAGES: Language[] = [
  ...
  { code: "tr", label: "Türkçe", englishLabel: "Turkish", dir: "ltr", active: true },
  { code: "de", label: "Deutsch", englishLabel: "German", dir: "ltr", active: true },
  { code: "ar", label: "العربية", englishLabel: "Arabic", dir: "rtl", active: true },
  { code: "fr", label: "Français", englishLabel: "French", dir: "ltr", active: true },
  { code: "es", label: "Español", englishLabel: "Spanish", dir: "ltr", active: true },
  { code: "it", label: "Italiano", englishLabel: "Italian", dir: "ltr", active: true },
  { code: "nl", label: "Nederlands", englishLabel: "Dutch", dir: "ltr", active: true },
  { code: "el", label: "Ελληνικά", englishLabel: "Greek", dir: "ltr", active: true },
  { code: "ro", label: "Română", englishLabel: "Romanian", dir: "ltr", active: true },
