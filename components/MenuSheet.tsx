...
// ─────────────────────────────────────────────────────────────
// MenuSheet — tam ekran menü (alt bardaki "Menu" butonu açar).
// Dil seçimi + var olan sayfalara linkler. 14 dilli.
// open=false iken render edilmez.
// ─────────────────────────────────────────────────────────────
...
// Dil değiştirme: mevcut yolun başındaki /xx kısmını yeni dile çevirir
  ...
  return (
    <div className="fixed inset-0 z-[60] bg-cream flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4">
        {/* Dil seçimi */}
        <div className="text-[11px] uppercase tracking-wide text-gray-500 font-medium mb-2">{t.mobile.language}</div>
